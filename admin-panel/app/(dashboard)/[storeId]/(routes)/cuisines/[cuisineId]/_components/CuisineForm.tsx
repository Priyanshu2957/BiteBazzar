...
const CuisineForm = ({initialData}:CuisineFormProps) => {
    ...
    const toastSucess = initialData? "Cuisine Updated": "Cuisine Created"
    const desc = initialData? "Edit an existing Cuisine": "Add a new Cuisine"
    ...
    const onSubmit = async(data:z.infer<typeof FormSchema>)=>{
        try {
            ...
            if(initialData){
                ...
                toast.success("Cuisine name updated...")
            }else{
                        ...
                        <FormField control={form.control} name="name" render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input 
                                        disabled={isLoading}
                                        placeholder="Your cuisine Label"
                                        {...field}
                                    />
                                </FormControl>
                                <FormMessage />
